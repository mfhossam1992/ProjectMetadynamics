...
int main(int argc, const char * argv[]) {
    ...
    // Initiate structure from my long equilibrated trajectories
    Init * init = new Init("file","/Users/hossamfarag/Desktop/Meta_RUNS2/orig/0p9_init.xyz","/Users/hossamfarag/Desktop/Meta_RUNS2/orig/0p9_v_init.xyz", 0, 0.5); // mode, filename_r, filename_v, desired_frame_number, T0
...
//
////// Very LONG Equilibration at T = 0.9
////    MD equil_final(equilib2, anderson, equil2_Temp, eta, false, rc, meta_rc, h, fileName, 100000, trajFileName );
////    delete equilib2;
////    equil_final.simulate();
